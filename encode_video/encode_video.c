...
static void save_all_packets_one_file(AVPacket *pkt, const char *name)
{
	static FILE *f = NULL;
...
#else
		save_all_packets_one_file(pkt, "output.h264");
#endif
		av_packet_unref(pkt);
	}
}
...
int main(int argc, char **argv)
{
	...
	filename = argv[1];
	codec_name = "libx264";  // TODO: change encoder's name here
